...
public class Query {
    ...
    public void Run(ActionEvent event)  {
        try{Connection con = DriverManager.getConnection("jdbc:oracle:oci8:@",LogInController.getUsr(),LogInController.getPass());
...
//                }
        ...
        //out.setText(output);
        System.out.println(output);con.close();st.close();}catch(Exception e){
            out.setText("");
            in.setText("");
        }
    }
